...
func Help(c *gin.Context) {
	...
	cmdMap["2.-"] = "========================【日志】==========================================================================================================================================================="
	cmdMap["2.1 动态修改日志"] = "-----------------: " + "curl -X PUT http://localhost:" + pre(port) + "/config/update -d '{\"key\":\"logger.level\", \"value\":\"debug\"}'"
	cmdMap["3.-"] = "===================【接口出入参】==========================================================================================================================================================="
	cmdMap["3.1 指定url打印请求"] = "--------------: " + "curl -X PUT http://localhost:" + pre(port) + "/config/update -d '{\"key\":\"server.request.print.include-uri[0]\", \"value\":\"/api/xx/xxx\"}'"
	cmdMap["3.2 指定url不打印请求"] = "------------: " + "curl -X PUT http://localhost:" + pre(port) + "/config/update -d '{\"key\":\"server.request.print.exclude-uri[0]\", \"value\":\"/api/xx/xxx\"}'"
	cmdMap["3.3 指定url打印请求和响应"] = "---------: " + "curl -X PUT http://localhost:" + pre(port) + "/config/update -d '{\"key\":\"server.response.print.include-uri[0]\", \"value\":\"/api/xx/xxx\"}'"
	cmdMap["3.4 指定url不打印请求和响应"] = "-------: " + "curl -X PUT http://localhost:" + pre(port) + "/config/update -d '{\"key\":\"server.response.print.exclude-uri[0]\", \"value\":\"/api/xx/xxx\"}'"
	cmdMap["4.-"] = "===================【bean管理】============================================================================================================================================================"
	...
	cmdMap["5.-"] = "=====================【pprof】============================================================================================================================================================"
	cmdMap["5.1 动态启用pprof"] = "---------------: " + "curl -X PUT http://localhost:" + pre(port) + "/config/update -d '{\"key\":\"server.gin.pprof.enable\", \"value\":\"true\"}'"
	cmdMap["6.-"] = "===================【配置处理】============================================================================================================================================================="
...
func apiPreAndModule() string {
	apiPrefix := config.GetValueStringDefault("api.prefix", "/api")
